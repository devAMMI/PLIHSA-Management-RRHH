import { Home, Users, ClipboardCheck, BarChart2, Settings, LogOut, User as UserIcon, Shield, FileText, Database, Terminal, Activity, CalendarDays, ShieldCheck, CalendarClock } from 'lucide-react';
...
export function Sidebar({ currentView, onViewChange }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'evaluacion-junio-v2', label: 'Revisión de Metas', icon: null, phaseNumber: 2, requiredRoles: ['superadmin', 'admin', 'rrhh', 'manager', 'jefe'] },
    ...
    { id: 'reportes', label: 'Reportes', icon: BarChart2, requiredRoles: ['superadmin', 'admin', 'rrhh'] },
    { id: 'employee-report', label: 'Reporte de Empleados', icon: Users, requiredRoles: ['superadmin', 'admin', 'rrhh'] },
