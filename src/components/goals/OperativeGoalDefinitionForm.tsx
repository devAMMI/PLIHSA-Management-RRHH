...
export function OperativeGoalDefinitionForm({ onBack }: OperativeGoalDefinitionFormProps) {
  ...
  const handleSave = async () => {
    ...
    if (existingDefinition) {
      setMessage({ type: 'error', text: 'Este empleado ya tiene una definición de factores registrada para este año.' });
      return;
    }
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-700 mt-0.5">
                      Este empleado ya tiene una definicion de factores en {new Date().getFullYear()}.
                    </p>
