        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-8 rounded-t-lg">
          <div className="flex items-center gap-4">
            ...
            <div className="text-white">
              <h1 className="text-3xl font-bold mb-2">Evaluación de Desempeño Administrativo</h1>
              <p className="text-blue-100">Definición de Metas Individuales y Competencias - Marzo 2026</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8">
          <div className="mb-8">
            ...
            <p className="text-slate-600 text-lg">
              Este formulario está diseñado para definir y evaluar el desempeño de los colaboradores administrativos.
              A través de este proceso, podrás establecer metas individuales y competencias conductuales
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <div>
                  <h4 className="font-semibold text-slate-800 mb-1">Metas Individuales</h4>
                  <p className="text-sm text-slate-600">
                    Definición de 5 metas específicas con sus mediciones y resultados esperados.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-4 bg-orange-50 rounded-lg border border-orange-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Definición de las 5 principales competencias conductuales y habilidades.
                  </p>
                </div>
              </div>
          ...
          <div className="mb-8 p-6 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <ol className="space-y-3">
              <li className="flex gap-3">
                ...
                <p className="text-slate-700 pt-1">Selecciona al colaborador administrativo que deseas evaluar</p>
              </li>
              <li className="flex gap-3">
              ...
              <li className="flex gap-3">
                ...
                <p className="text-slate-700 pt-1">Define las 5 metas individuales con sus mediciones y resultados esperados</p>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold">4</span>
                <p className="text-slate-700 pt-1">Establece las 5 principales competencias conductuales y habilidades</p>
              </li>
              <li className="flex gap-3">
